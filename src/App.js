      ...
      return (
        <div id="container">
          <div id="editor-container">
            <div id="nav-editor">
              <span>Editor</span>
              <i id="icon-expand-editor" class="fas fa-expand-arrows-alt" onClick={this.expandEditor}></i>
              <i id="icon-minimize-editor" class="fas fa-compress-alt hide" onClick={this.minimizeEditor}></i>
            </div>
            <textarea 
              id="editor" 
          ...
          <div id="previewer-container">
            ...
            <span>Previewer</span>
            <i id="icon-expand-previewer" class="fas fa-expand-arrows-alt" onClick={this.expandPreviewer}></i>
            <i id="icon-minimize-previewer" class="fas fa-compress-alt hide" onClick={this.minimizePreviewer}></i>
            </div>
